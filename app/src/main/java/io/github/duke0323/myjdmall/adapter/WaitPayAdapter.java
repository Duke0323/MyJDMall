 ...
 */
public class WaitPayAdapter extends JDBaseAdapter<OrderStatusBean> {
    Context mContext;
    private String mTn;
    private ICancelOrderListener mListener;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Button cancel_btn = ViewHolder.get(convertView, R.id.cancel_btn);
            ...
            case 0:
                ...
                do_btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra(IntentValues.ALIPAYTN, orderStatusBean.getTn());
                ...
                cancel_btn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                       mListener.onCancel(String.valueOf(orderStatusBean.getOid()));
                    }
                });
                break;
            case 1:
    ...
    public void setlistener(ICancelOrderListener listener) {
        mListener=listener;
    }
}
