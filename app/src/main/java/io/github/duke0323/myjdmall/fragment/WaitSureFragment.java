...
import io.github.duke0323.myjdmall.adapter.WaitSureAdapter;
 ...
 */
public class WaitSureFragment extends BaseFragemnt implements IModelChangeListener, XListView.IXListViewListener {
    private XListView mXListView;
    private WaitSureAdapter mAdapter;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        initController();
        initView();
        mController.sendAsyncMessage(IDiyMessage.GET_ORDER_ACTION, 3);
    }
    ...
    protected void initView() {
        mXListView = (XListView) getActivity().findViewById(R.id.wait_sure_lv);
        null_image = (ImageView) getActivity().findViewById(R.id.wait_sure_null_view).findViewById(R.id.null_image);
        mXListView.setPullRefreshEnable(true);
        mXListView.setPullLoadEnable(true);
        mXListView.setXListViewListener(this);
        mAdapter = new WaitSureAdapter(getActivity());
